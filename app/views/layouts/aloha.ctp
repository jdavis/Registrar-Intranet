...
<head>
	...
	<script type="text/javascript" src="/js/aloha/plugins/com.gentics.aloha.plugins.HighlightEditables/plugin.js"></script> 
	<script type="text/javascript">
		...
		function() {
			...
			$('header a').bind('click', noClick);
			$('footer a').bind('click', noClick);
			$('.navigation').bind('click', noClick);
		});
	</script>
</script>
	<!--[if lte IE 8]>
